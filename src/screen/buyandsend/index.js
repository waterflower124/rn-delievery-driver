...
class BuyandsendPage extends React.Component{
 ...
 <Text style={{fontSize:22,fontWeight:'bold',color:'#1f4b70'}}> Buy & Send </Text>
...
<Content padder>
  ...
  {/* <Text style={{textAlign:'center',fontSize:15,marginTop:50,color:'#000000'}}>Buy & Send</Text>  */}
...
<TextInput
            style={{height:75,width: "95%",borderColor: "grey",borderWidth: .5,marginTop:5,alignSelf:'center',paddingLeft:10,borderRadius:5}}
            // Adding hint in TextInput using Placeholder option.
            placeholder="Price of your purchase"
            //set the value in state.
            // onChangeText={TextInputValue => this.onEnterText(TextInputValue)}
            // Making the Under line Transparent.
            underlineColorAndroid="transparent"
 ...
 <Image source={require('../../assets/sort-down.png')} style={styles.ImageStyle} resizeMode='contain' />
...
<View style={styles.SectionStyle}>
 ...
 <TextInput
     style={{flex:1}}
     placeholder="Where to delivered"
     underlineColorAndroid="transparent"
 />
...
<TextInput
            style={{height:75,width: "95%",borderColor: "grey",borderWidth: .5,marginTop:5,alignSelf:'center',paddingLeft:10,borderRadius:5}}
            // Adding hint in TextInput using Placeholder option.
            placeholder="Purchase observasion"
            //set the value in state.
            // onChangeText={TextInputValue => this.onEnterText(TextInputValue)}
            // Making the Under line Transparent.
            underlineColorAndroid="transparent"
