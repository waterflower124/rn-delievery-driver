...
class GiftandparentPage extends React.Component{
 ...
 <Text style={{fontSize:22,fontWeight:'bold',color:'#1f4b70'}}> Make A Gift </Text>
...
<Content padder>
  ...
  {/* <Text style={{textAlign:'center',fontSize:15,marginTop:50,color:'#000000'}}>Make A Gift</Text>  */}
...
<TextInput
            ...
            placeholder="Name of the recipt"
...
<TextInput
            ...
            // Adding hint in TextInput using Placeholder option.
            placeholder="Indicate more detail to dilevery gift"
            //set the value in state.
            // onChangeText={TextInputValue => this.onEnterText(TextInputValue)}
            // Making the Under line Transparent.
            underlineColorAndroid="transparent"
